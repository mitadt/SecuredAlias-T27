...
public class EmailUtility {
    ...
    public static void sendEmailWithAttachment(String host, String port,
            ...
            String subject, String message,File[] attachedFiles)
        ...
        System.out.println("emailIds "+Arrays.deepToString(toAddress));
        for (int i = 0; i < toAddress.length; i++)
        {       	
        	toAddresses[i] = new InternetAddress(toAddress[i]);
        }
        System.out.println("emailIds "+Arrays.deepToString(toAddresses));
      ...
      //Adding message
        ...
        if (attachedFiles != null) {
                ...
                for (int i = 0; i < attachedFiles.length; i++){
                	try {
                        attachPart.attachFile(attachedFiles[i]);
